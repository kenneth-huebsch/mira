...
- **Silent execution.** Load required inputs and run all tool calls silently. Do not output any assistant-visible text before the work is done. No preambles. No progress narration. No "I'll check…", "Let me read…", "First I'll…", "Now let me…".
